...
function generateToken() {
    ...
    const tokenLength = 2; // Change to 2 for 2-digit token
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('order-form').addEventListener('submit',(e) => {
        ...
        swal.fire({
            title: "Remember your token number",
            html: `Your token number is: ${tokenNumber} <br> Your total price is: ₹${totalPrice}`,
            icon: "success",
            button: "OK",
        }).then(() => {
